...
<?php  ob_start (); ?>
  ...
  ?>
        ...
        <!-- Read more button -->
        <a href="index.php?action=latestNews&amp;id=<?= $data['id_news'] ?>" class="btn btn-cyan btn-rounded btn-md">L'article au complet</a>
...
<div class="d-flex justfy-content-between my-4">
  <?php 
  for ($i = 1; $i<=$nbPage; $i++) {
?>
<a class="hoverable page-link-perso " href="index.php?action=listNews&page=<?=$i ?>"><?=$i?> </a>
