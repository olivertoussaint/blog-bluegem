...
<?php  ob_start (); ?>
            ...
            <div class="container mt-6">
              <section class="dark-grey-text text-center">
                <p class="text-center mx-auto w-responsive mb-5 p-shadow-5 px-2 py-4 rounded mb-0 background-c fzr">Bienvenu(e) sur <span class="colored-logo">BlueGem</span>, le site d'actualités qui s'interroge sur l'évolution de la biodiversité sur notre belle planète bleue.
                  ...
                  <h2 class="font-weight-bold mt-3 mb-4 pb-2"><span class="py-2 px-2  rounded z-depth-3">Derniers Articles</span></h2>
                  <div class="row">
            <?php
            ...
            ?>
                ...
                <h6 class="font-weight-bold mb-3 z-depth-3 perso-size background-c">
              ...
              <p class="date">Mise en ligne le &nbsp;<?=($data['creation_date_fr'])?>&nbsp;<p class="font-weight-bold ml-n12 mt-n3">par&nbsp;&nbsp;<?=($data['pseudo'])?></p></p>
